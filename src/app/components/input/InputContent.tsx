...
const InputContent = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    className="${borderType.class} ${
      width.class
    } px-[${xPadding}px] py-[${yPadding}px]  ${borderColor.border} ${
      radius.class
          ...
          <div className='bg-white py-32 w-full mx-auto pl-6 pr-4'>
            ...
            >
              <input
                ...
                id={labelText}
                placeholder={placeholderText}
                className={`${borderType.class} ${width.class}  border-black bg-transparent focus:outline-none placeholder:text-sm`}
                style={{
