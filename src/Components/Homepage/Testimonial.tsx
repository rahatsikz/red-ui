  ...
  const testimonialData = [
    {
      name: "Ruman Islam",
      description:
        "Red UI made building my React app a breeze! With its intuitive interface and customizable components, I was able to create a stunning user interface in no time. I highly recommend Red UI to anyone.",
    ...
    <section className='container mx-auto my-12 px-4 2xl:px-0'>
      ...
      <div className='grid grid-cols-1 xl:grid-cols-2 gap-8'>
        {testimonialData.map((data, index) => (
          <div
            key={index}
            className='overflow-hidden bg-white rounded-md shadow-lg text-secondary shadow-slate-200'
          >
            <div className='relative px-6 py-10'>
              <figure className='relative z-10'>
                <blockquote className='p-6 text-base leading-relaxed'>
                  <p>{data.description}</p>
                </blockquote>
                <figcaption className='flex items-center justify-end gap-4 p-6 pt-2 text-sm text-primary'>
